...
// CODE HERE
const addColor = () =>{
    sayHelloButton.classList.add("white")

}

sayHelloButton.addEventListener('mouseover', addColor)
...
// CODE HERE
const removeColor = () =>{
    sayHelloButton.classList.remove("white")
...
const repeatMyParam = () => {
    //YOUR CODE HERE
    axios.get('http://localhost:3000/repeat/coding-is-dope').then(res => {
...
// CODE HERE
const aFunc =() =>{
    axios.get('http://localhost:3000/query-test?thisquery=my-name-is-chris').then(res => {
        console.log(res.data)
    })
}
